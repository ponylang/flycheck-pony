...
sed -i -e "s/;; Version: \(.*\)$/;; Version: ${VERSION}/g" flycheck-pony.el

# commit flycheck-pony.el updates
echo -e "\e[34mCommiting flycheck-pony.el changes\e[0m"
git add flycheck-pony.el
